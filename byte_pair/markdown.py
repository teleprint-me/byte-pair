...
This script processes files recursively in the input directory, converts HTML to Markdown, and handles exceptions appropriately for reading and writing files.
